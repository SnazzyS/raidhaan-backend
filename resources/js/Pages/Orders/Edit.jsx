...
export default function OrderEdit({ order, items = [], categories = [] }) {
    const { data, setData, put, processing, errors } = useForm({
        phone_number: order.customer?.phone_number?.toString() || '',
                        ...
                        <Card>
                            ...
                            <div className="p-4 space-y-4">
                                <Select
                                    ...
                                    onChange={(e) => setData('order', { ...data.order, status: e.target.value })}
                                />
                                <Select
                                    label="Delivery"
                                    options={[
